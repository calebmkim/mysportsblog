...
Two notes:
-  I'm only going to rank one team for back-to-back champions.
For example, since the '16-'17 Warriors are already ranked, I'm going to exclude the slightly-worse '17-'18 Warriors.
- All the stats I got are from [StatMuse](https://www.statmuse.com/questions), ESPN, or Wikipedia. Mainly StatMuse though.

### Tier 1: Obviously the Best
...
2) The East wasn't that strong so they didn't have to be great to get the 1 seed.
...
### Tier 4: Good, like all NBA champions
...
This is another difficult team to rank.
...
They then beat the Warriors in 6 in the Finals: most people point to the fact that KD was injured for basically the entire series, and Klay got injured in Game 6.
...
While these teams are probably more difficult than, for example, the Lakers' run to the Finals, I don't think it's a particularly difficult road.
...
But I think this series (and the entire season) was more about Steph Curry being great individually than the Warriors as a team being as great as they were previously.
